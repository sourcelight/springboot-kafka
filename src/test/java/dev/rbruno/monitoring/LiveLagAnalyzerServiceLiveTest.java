package dev.rbruno.monitoring;

import dev.rbruno.monitoring.service.LagAnalyzerService;
...
public class LiveLagAnalyzerServiceLiveTest {
    ...
    private static final String GROUP_ID = "rbrunoGrp";
    private static final String TOPIC = "rbruno";
